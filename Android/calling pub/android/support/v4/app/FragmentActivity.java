...
public class FragmentActivity extends Activity {
   ...
   public LoaderManager getSupportLoaderManager() {
      if(this.mLoaderManager != null) {
         ...
         this.mLoaderManager = this.getLoaderManager((String)null, this.mLoadersStarted, true);
         return this.mLoaderManager;
      }
   }
   ...
   public boolean onPreparePanel(int var1, View var2, Menu var3) {
      if(var1 == 0 && var3 != null) {
         ...
         return super.onPreparePanel(var1, var2, var3) | this.mFragments.dispatchPrepareOptionsMenu(var3);
      } else {
   ...
   public final Object onRetainNonConfigurationInstance() {
      ...
      HashMap var3 = this.mAllLoaderManagers;
      boolean var4 = false;
      if(var3 != null) {
         LoaderManagerImpl[] var6 = new LoaderManagerImpl[this.mAllLoaderManagers.size()];
         this.mAllLoaderManagers.values().toArray(var6);
         var4 = false;
         if(var6 != null) {
            for(int var8 = 0; var8 < var6.length; ++var8) {
               LoaderManagerImpl var9 = var6[var8];
               if(var9.mRetaining) {
                  var4 = true;
               } else {
                  var9.doDestroy();
                  this.mAllLoaderManagers.remove(var9.mWho);
               }
            }
         }
      }
   ...
   protected void onStart() {
      ...
      if(!this.mLoadersStarted) {
         ...
         if(this.mLoaderManager != null) {
            ...
            this.mLoaderManager = this.getLoaderManager((String)null, this.mLoadersStarted, false);
      ...
      if(this.mAllLoaderManagers != null) {
         LoaderManagerImpl[] var2 = new LoaderManagerImpl[this.mAllLoaderManagers.size()];
         this.mAllLoaderManagers.values().toArray(var2);
         if(var2 != null) {
