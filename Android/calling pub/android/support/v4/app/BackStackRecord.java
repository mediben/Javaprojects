...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, Runnable {
   ...
   void bumpBackStackNesting(int var1) {
      if(this.mAddToBackStack) {
         ...
         for(BackStackRecord.Op var2 = this.mHead; var2 != null; var2 = var2.next) {
   ...
   public void dump(String var1, PrintWriter var2, boolean var3) {
      ...
      if(this.mHead != null) {
         ...
         String var4 = var1 + "    ";
         BackStackRecord.Op var5 = this.mHead;
   ...
   public void popFromBackStack(boolean var1) {
      ...
      for(BackStackRecord.Op var2 = this.mTail; var2 != null; var2 = var2.prev) {
         switch(var2.cmd) {
         case 1:
   ...
   public void run() {
      ...
      if(this.mAddToBackStack && this.mIndex < 0) {
         ...
         for(BackStackRecord.Op var1 = this.mHead; var1 != null; var1 = var1.next) {
            switch(var1.cmd) {
            case 1:
