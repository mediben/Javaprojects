...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
   ...
   final BroadcastReceiver mMediaButtonReceiver = new BroadcastReceiver() {
      public void onReceive(Context var1, Intent var2) {
         try {
            KeyEvent var5 = (KeyEvent)var2.getParcelableExtra("android.intent.extra.KEY_EVENT");
            TransportMediatorJellybeanMR2.this.mTransportCallback.handleKey(var5);
         } catch (ClassCastException var6) {
            Log.w("TransportController", var6);
         }
      }
   };
